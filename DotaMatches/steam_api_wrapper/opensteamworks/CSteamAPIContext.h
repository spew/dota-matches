...
public:
	...
	ISteamGameCoordinator001* SteamGameCoordinator()           { return m_pSteamGameCoordinator; }
...
private:
	...
	ISteamGameCoordinator001 *m_pSteamGameCoordinator;
};
...
inline bool CSteamAPIContext::Init()
{
	...
	m_pSteamGameCoordinator = (ISteamGameCoordinator001 *)SteamClient()->GetISteamGenericInterface(hSteamUser, hSteamPipe, "SteamGameCoordinator001");
